        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <div className="flex items-center gap-1">
            <div className="relative flex items-center">
              <Database size={13} className="absolute left-2.5 text-slate-400 pointer-events-none" />
              <select
                value={currentDatabase}
                onChange={(e) => onSelectDatabase(e.target.value)}
                className="bg-slate-50 hover:bg-white text-slate-800 text-xs rounded-md border border-slate-300 pl-7 pr-6 py-1 focus:outline-none focus:border-blue-500 focus:bg-white transition cursor-pointer appearance-none font-mono font-medium"
